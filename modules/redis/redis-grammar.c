...
#define KW_REDIS 10514
#define KW_COMMAND 10515
#define KW_AUTH 10516
...
#line 434 "modules/redis/redis-grammar.c" /* yacc.c:358  */
...
#line 502 "modules/redis/redis-grammar.c" /* yacc.c:359  */
...
{
       0,   373,   373,   372,   380,   381,   385,   390,   394,   399,
     404,   409,   414,   415,   415,   650,   657,   670,   670,   676,
     677,   692,   699,   706,   713,   779,   813,   814,   815,   837,
     842,   846,   989,   990,   991,   992,   993,   994
};
#endif
...
{
       4,  -132,    15,  -134,  -134,  -131,   -72,  -129,  -126,  -125,
    -123,  -120,  -134,  -119,  -118,  -116,  -133,   -72,   -67,  -134,
    -134,  -134,   -94,   -92,  -122,   -94,  -122,   -94,  -122,  -122,
    -134,  -134,  -114,  -112,  -111,  -110,  -108,  -107,  -134,  -134,
    -134,  -106,  -134,  -134,  -105,  -134,  -134,  -104,  -103,  -102,
    -101,  -134,  -100,  -122,   -92,  -122,  -122,  -122,  -122,  -134,
    -134,  -134,  -134,  -134,  -134,   -99,  -117,  -134,   -91,   -90,
     -89,   -88,   -87,   -86,  -134,   -84,   -82,  -134,  -134,  -134,
    -134,  -134,  -134,  -134,  -134,  -134,   -81,  -122,  -134,   -80,
    -134
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,     0,    28,     0,     0,     0,     0,    13,     0,    29,
      31,    12,     0,     0,     0,     0,     0,     0,     0,     0,
       3,     4,     0,     0,     0,     0,     0,     0,    14,    23,
      24,     0,    21,    22,     0,    19,    20,     0,     0,     0,
       0,    17,     0,     0,     0,     0,     0,     0,     0,    26,
      27,    25,     7,     6,    30,    17,     0,     8,     0,     0,
       0,     0,     0,     0,     9,    17,    19,    18,    15,    32,
      33,    34,    35,    36,    37,    10,     0,     0,    11,     0,
      16
};
...
{
    -134,  -134,  -134,    25,  -134,  -134,  -134,   -64,  -134,    -2,
    -134,     3,  -134,   -13,  -134,  -134,  -134,  -134
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     5,    16,    17,    18,    77,    65,    66,    47,
      43,    44,    40,    41,    19,    20,    21,    38
};
...
{
       7,    75,    45,    32,    33,    46,     8,    76,     1,     9,
      46,    86,    48,     3,    50,     4,    30,     6,    34,    22,
      35,    36,    23,    24,    49,    25,    51,    52,    26,    27,
      28,    39,    29,    42,    53,    10,    54,    55,    56,    11,
      57,    58,    31,    59,    60,    61,    62,    63,    64,    67,
      74,    68,    12,    70,    71,    72,    73,    69,    79,    80,
      81,    82,    83,    84,    78,    85,    87,     0,    88,    90,
       0,     0,    13,     0,    14,    15,    37,    -5,     0,     0,
       0,     0,     0,     0,     0,    89
};

static const yytype_int16 yycheck[] =
{
      72,    65,   124,    70,    71,   127,    78,   124,     4,    81,
     127,    75,    25,   145,    27,     0,   149,   148,    85,   148,
      87,    88,   148,   148,    26,   148,    28,    29,   148,   148,
     148,   125,   148,   125,   148,   107,   148,   148,   148,   111,
     148,   148,    17,   149,   149,   149,   149,   149,   149,   149,
     149,    53,   124,    55,    56,    57,    58,    54,   149,   149,
     149,   149,   149,   149,    66,   149,   148,    -1,   149,   149,
      -1,    -1,   144,    -1,   146,   147,   143,   149,    -1,    -1,
      -1,    -1,    -1,    -1,    -1,    87
};
...
{
       0,     4,   155,   145,     0,   156,   148,    72,    78,    81,
     107,   111,   124,   144,   146,   147,   157,   158,   159,   168,
     169,   170,   148,   148,   148,   148,   148,   148,   148,   148,
     149,   157,    70,    71,    85,    87,    88,   143,   171,   125,
     166,   167,   125,   164,   165,   124,   127,   163,   167,   163,
     167,   163,   163,   148,   148,   148,   148,   148,   148,   149,
     149,   149,   149,   149,   149,   161,   162,   149,   163,   165,
     163,   163,   163,   163,   149,   161,   124,   160,   163,   149,
     149,   149,   149,   149,   149,   149,   161,   148,   149,   163,
     149
};
...
{
       0,   154,   156,   155,   157,   157,   158,   158,   158,   158,
     158,   158,   158,   159,   158,   160,   160,   162,   161,   163,
...
#line 292 "modules/redis/redis-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2529 "modules/redis/redis-grammar.c" /* yacc.c:1257  */
        break;

    case 127: /* LL_STRING  */
#line 292 "modules/redis/redis-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2535 "modules/redis/redis-grammar.c" /* yacc.c:1257  */
        break;

    case 129: /* LL_BLOCK  */
#line 292 "modules/redis/redis-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2541 "modules/redis/redis-grammar.c" /* yacc.c:1257  */
        break;

    case 163: /* string  */
#line 292 "modules/redis/redis-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2547 "modules/redis/redis-grammar.c" /* yacc.c:1257  */
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 373 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            last_driver = *instance = redis_dd_new(configuration);
          }
#line 2843 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 376 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2849 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;
...
#line 2858 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 7:
#line 391 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            redis_dd_set_port(last_driver, (yyvsp[-1].num));
          }
#line 2866 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 8:
#line 395 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            redis_dd_set_auth(last_driver, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
          }
#line 2875 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 400 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            redis_dd_set_command(last_driver, (yyvsp[-2].cptr), (yyvsp[-1].ptr), NULL, NULL);
            free((yyvsp[-2].cptr));
          }
#line 2884 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 10:
#line 405 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            redis_dd_set_command(last_driver, (yyvsp[-3].cptr), (yyvsp[-2].ptr), (yyvsp[-1].ptr), NULL);
            free((yyvsp[-3].cptr));
          }
#line 2893 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 11:
#line 410 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
...
#line 2919 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 16:
#line 658 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
          GError *error = NULL;
...
#line 2933 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 17:
#line 670 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template = log_template_new(configuration, NULL); }
#line 2939 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 18:
#line 670 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_template; }
#line 2945 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 21:
#line 693 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            CHECK_ERROR(((yyvsp[0].num) >= 0), (yylsp[0]), "It cannot be negative");
          }
#line 2953 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 22:
#line 700 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            CHECK_ERROR(((yyvsp[0].num) <= G_MAXINT32), (yylsp[0]), "Must be smaller than 2^31");
          }
#line 2961 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 23:
#line 707 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            CHECK_ERROR(((yyvsp[0].num) > 0), (yylsp[0]), "Must be positive");
          }
#line 2969 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 24:
#line 714 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            CHECK_ERROR(((yyvsp[0].num) <= G_MAXINT32), (yylsp[0]), "Must be smaller than 2^31");
          }
#line 2977 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
  ...
  case 25:
#line 779 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
...
#line 2983 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
  ...
  case 26:
#line 813 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { ((LogDestDriver *) last_driver)->log_fifo_size = (yyvsp[-1].num); }
#line 2989 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 27:
#line 814 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { ((LogDestDriver *) last_driver)->throttle = (yyvsp[-1].num); }
#line 2995 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 28:
#line 816 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
            Plugin *p;
...
#line 3021 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 30:
#line 843 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
          log_threaded_dest_driver_set_max_retries(last_driver, (yyvsp[-1].num));
        }
#line 3029 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 32:
#line 989 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options->ts_format = cfg_ts_format_value((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 3035 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 33:
#line 990 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options->frac_digits = (yyvsp[-1].num); }
#line 3041 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 34:
#line 991 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options->time_zone[LTZ_SEND] = g_strdup((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 3047 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 35:
#line 992 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options->time_zone[LTZ_SEND] = g_strdup((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 3053 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 36:
#line 993 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    { last_template_options->time_zone[LTZ_LOCAL] = g_strdup((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 3059 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;

  case 37:
#line 995 "modules/redis/redis-grammar.y" /* yacc.c:1646  */
    {
          gint on_error;
...
#line 3072 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
    break;


#line 3076 "modules/redis/redis-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 1076 "modules/redis/redis-grammar.y" /* yacc.c:1906  */
