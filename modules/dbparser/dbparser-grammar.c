...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_RETRIES = 10512,
    KW_DB_PARSER = 10514,
    KW_GROUPING_BY = 10515,
    KW_INJECT_MODE = 10516,
    KW_INHERIT_MODE = 10517,
    KW_TIMEOUT = 10518,
    KW_TRIGGER = 10519,
    KW_WHERE = 10520,
    KW_HAVING = 10521,
...
#define KW_DB_PARSER 10514
#define KW_GROUPING_BY 10515
#define KW_INJECT_MODE 10516
#define KW_INHERIT_MODE 10517
#define KW_TIMEOUT 10518
#define KW_TRIGGER 10519
#define KW_WHERE 10520
#define KW_HAVING 10521
#define KW_AGGREGATE 10522
#define KW_VALUE 10523
#define KW_DROP_UNMATCHED 10524
#define KW_FILE 10525
...
#line 451 "modules/dbparser/dbparser-grammar.c" /* yacc.c:358  */
...
#line 528 "modules/dbparser/dbparser-grammar.c" /* yacc.c:359  */
...
{
       0,   399,   399,   404,   403,   410,   409,   417,   418,   423,
     424,   425,   429,   430,   434,   440,   444,   445,   449,   450,
     452,   451,   459,   458,   465,   471,   473,   472,   479,   483,
     483,   488,   489,   493,   494,   500,   504,   513,   754,   761,
     774,   774,   780,   781,   785,   786,   787,   796,   803,   871
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_REPLACE_PREFIX", "KW_ON_ERROR", "KW_RETRIES", "KW_DB_PARSER",
  "KW_GROUPING_BY", "KW_INJECT_MODE", "KW_INHERIT_MODE", "KW_TIMEOUT",
  "KW_TRIGGER", "KW_WHERE", "KW_HAVING", "KW_AGGREGATE", "KW_VALUE",
  "KW_DROP_UNMATCHED", "KW_FILE", "'('", "')'", "'{'", "'}'", "';'", "':'",
  "$accept", "start", "parser_expr_db", "$@1", "$@2", "parser_db_opts",
  "parser_db_opt", "stateful_parser_opt", "stateful_parser_inject_mode",
  "grouping_by_opts", "grouping_by_opt", "$@3", "$@4", "$@5",
  "synthetic_message", "$@6", "synthetic_message_opts",
  "synthetic_message_opt", "inherit_mode", "context_scope",
  "template_content_inner", "template_content", "$@12", "string", "yesno",
  "nonnegative_integer64", "nonnegative_integer", "parser_opt", YY_NULLPTR
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
   ...
   10519, 10520, 10521, 10522, 10523, 10524, 10525,    40,    41,   123,
     125,    59,    58
};
# endif
...
{
       0,  -128,    12,  -138,  -137,  -139,  -139,  -139,  -139,  -100,
     -86,  -136,  -135,  -133,  -132,  -130,  -100,  -139,  -139,  -131,
    -127,  -126,  -125,  -124,  -123,  -122,  -139,  -129,   -86,  -114,
     -35,  -110,  -114,  -139,  -139,  -139,  -114,   -89,  -139,  -139,
    -139,  -139,  -139,  -139,  -139,  -139,  -120,  -139,  -119,  -139,
    -139,  -139,  -139,  -118,  -117,  -116,  -113,  -112,  -139,  -139,
    -139,  -109,  -106,  -105,  -104,   -96,  -111,  -139,  -139,  -139,
    -139,  -139,   -88,  -139,  -139,  -139,  -139,  -139,  -139,  -139,
    -139,   -87,   -85,   -84,  -139,  -111,  -114,  -114,  -114,  -114,
"modules/dbparser/dbparser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2571 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1257  */
        break;

    case 127: /* LL_STRING  */
#line 305 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2577 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1257  */
        break;

    case 129: /* LL_BLOCK  */
#line 305 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2583 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1257  */
        break;

    case 186: /* string  */
#line 305 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2589 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1257  */
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 399 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2883 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 404 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
            last_parser = *instance = (LogParser *) log_db_parser_new(configuration);
          }
#line 2891 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;
...
#line 2899 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 423 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { log_db_parser_set_db_file(((LogDBParser *) last_parser), (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2905 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 10:
#line 424 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { log_db_parser_set_drop_unmatched(((LogDBParser *) last_parser), (yyvsp[-1].num)); }
#line 2911 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 12:
#line 429 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { stateful_parser_set_inject_mode(((StatefulParser *) last_parser), (yyvsp[-1].num)); }
#line 2917 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 14:
#line 435 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
...
#line 2927 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 15:
#line 440 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = stateful_parser_lookup_inject_mode("internal"); }
#line 2933 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;
...
#line 2939 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 19:
#line 450 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { grouping_by_set_scope(last_parser, (yyvsp[-1].num)); }
#line 2945 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 20:
#line 452 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
...
#line 2956 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;
...
#line 2967 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 24:
#line 466 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
            CHECK_ERROR((yyvsp[-1].num) >= 1, (yylsp[-3]), "timeout() needs to be greater than 1 second");

            grouping_by_set_timeout(last_parser, (yyvsp[-1].num));
          }
#line 2977 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 25:
#line 471 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { grouping_by_set_synthetic_message(last_parser, (yyvsp[-1].ptr)); }
#line 2983 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 26:
#line 473 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
            FilterExprNode *filter_expr;
...
#line 2994 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 29:
#line 483 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { last_message = synthetic_message_new(); }
#line 3000 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 30:
#line 483 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_message; }
#line 3006 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 33:
#line 493 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { synthetic_message_set_inherit_mode(last_message, (yyvsp[-1].num)); }
#line 3012 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 34:
#line 495 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
	    synthetic_message_add_value_template(last_message, (yyvsp[-2].cptr), (yyvsp[-1].ptr));
	    free((yyvsp[-2].cptr));
            log_template_unref((yyvsp[-1].ptr));
	  }
#line 3022 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 35:
#line 500 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { synthetic_message_add_tag(last_message, (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 3028 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 36:
#line 505 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
            (yyval.num) = synthetic_message_lookup_inherit_mode((yyvsp[0].cptr));
            free((yyvsp[0].cptr));
            CHECK_ERROR((yyval.num) >= 0, (yylsp[0]), "unknown inherit-mode()");
          }
#line 3038 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 37:
#line 514 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
            (yyval.num) = correllation_key_lookup_scope((yyvsp[0].cptr));
            free((yyvsp[0].cptr));
            CHECK_ERROR((yyval.num) >= 0, (yylsp[0]), "unknown context-scope()");
          }
#line 3048 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 38:
#line 755 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
          GError *error = NULL;
...
#line 3059 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 39:
#line 762 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
          GError *error = NULL;
...
#line 3073 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 40:
#line 774 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { last_template = log_template_new(configuration, NULL); }
#line 3079 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 41:
#line 774 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_template; }
#line 3085 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 44:
#line 785 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 1; }
#line 3091 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 45:
#line 786 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 0; }
#line 3097 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 46:
#line 787 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[0].num); }
#line 3103 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 47:
#line 797 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
            CHECK_ERROR(((yyvsp[0].num) >= 0), (yylsp[0]), "It cannot be negative");
          }
#line 3111 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 48:
#line 804 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
            CHECK_ERROR(((yyvsp[0].num) <= G_MAXINT32), (yylsp[0]), "Must be smaller than 2^31");
          }
#line 3119 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;

  case 49:
#line 871 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1646  */
    {
...
#line 3133 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
    break;


#line 3137 "modules/dbparser/dbparser-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 1180 "modules/dbparser/dbparser-grammar.y" /* yacc.c:1906  */
