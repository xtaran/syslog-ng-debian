...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_ON_ERROR = 10511,
    KW_RETRIES = 10512,
    KW_ADD_CONTEXTUAL_DATA = 10514,
    KW_DATABASE = 10515,
    KW_SELECTOR = 10516,
    KW_DEFAULT_SELECTOR = 10517,
    KW_PREFIX = 10518,
    KW_FILTERS = 10519,
    KW_IGNORE_CASE = 10520
  };
#endif
/* Tokens.  */
...
#define KW_ADD_CONTEXTUAL_DATA 10514
#define KW_DATABASE 10515
#define KW_SELECTOR 10516
#define KW_DEFAULT_SELECTOR 10517
#define KW_PREFIX 10518
#define KW_FILTERS 10519
#define KW_IGNORE_CASE 10520
...
#line 441 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:358  */
...
#include "messages.h"
#line 56 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:359  */
...
#line 512 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:359  */
...
{
       0,   385,   385,   391,   390,   401,   402,   406,   411,   412,
     416,   420,   426,   431,   695,   696,   700,   701,   702
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_ADD_CONTEXTUAL_DATA", "KW_DATABASE", "KW_SELECTOR",
  "KW_DEFAULT_SELECTOR", "KW_PREFIX", "KW_FILTERS", "KW_IGNORE_CASE",
  "'('", "')'", "'{'", "'}'", "';'", "':'", "$accept", "start",
  "parser_expr_add_contextual_data", "$@1",
  "parser_add_contextual_data_opts", "parser_add_contextual_data_opt",
  "parser_add_contextual_data_selector_opt", "string", "yesno", YY_NULLPTR
};
#endif
...
{
      -1,  -132,    14,  -136,  -141,  -141,  -141,  -140,  -135,  -134,
    -131,  -130,  -128,  -133,  -140,  -112,  -127,  -112,  -112,  -115,
    -141,  -141,  -141,  -141,  -126,  -141,  -124,  -123,  -122,  -121,
    -141,  -141,  -141,  -120,  -141,  -112,  -141,  -141,  -141,  -141,
    -119,  -141
};
...
static const yytype_uint8 yydefact[] =
{
       0,     0,     0,     0,     2,     1,     3,     6,     0,     0,
       0,     0,     0,     0,     6,     0,     0,     0,     0,     0,
       4,     5,    14,    15,     0,    13,     0,     0,     0,     0,
      16,    17,    18,     0,     7,     0,     8,     9,    10,    11,
       0,    12
};
...
{
    -141,  -141,  -141,  -141,    11,  -141,  -141,   -16,  -141
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     4,     7,    13,    14,    27,    24,    33
};
...
{
      25,    28,    29,    30,    31,     1,     8,     9,    10,    11,
      32,    12,    22,     3,     5,    23,     6,    15,    16,    40,
      20,    17,    18,    26,    19,    21,     0,    34,    35,     0,
      36,    37,    38,    39,    41
};

static const yytype_int16 yycheck[] =
{
     127,    17,    18,   118,   119,     6,   146,   147,   148,   149,
     125,   151,   124,   145,     0,   127,   152,   152,   152,    35,
     153,   152,   152,   150,   152,    14,    -1,   153,   152,    -1,
     153,   153,   153,   153,   153
};
...
{
       0,     6,   159,   145,   160,     0,   152,   161,   146,   147,
     148,   149,   151,   162,   163,   152,   152,   152,   152,   152,
     153,   162,   124,   127,   165,   127,   150,   164,   165,   165,
     118,   119,   125,   166,   153,   152,   153,   153,   153,   153,
     165,   153
};
...
{
       0,   158,   159,   161,   160,   162,   162,   163,   163,   163,
     163,   163,   164,   164,   165,   165,   166,   166,   166
};
...
#line 299 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2507 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1257  */
        break;

    case 127: /* LL_STRING  */
#line 299 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2513 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1257  */
        break;

    case 129: /* LL_BLOCK  */
#line 299 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2519 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1257  */
        break;

    case 165: /* string  */
#line 299 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2525 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1257  */
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 385 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2819 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 391 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            last_parser = *instance = add_contextual_data_parser_new(configuration);
          }
#line 2827 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 4:
#line 396 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_parser; }
#line 2833 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 7:
#line 407 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            add_contextual_data_set_filename(last_parser, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
        }
#line 2842 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 413 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            add_contextual_data_set_database_default_selector(last_parser, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
        }
#line 2851 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 10:
#line 417 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            add_contextual_data_set_prefix(last_parser, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
        }
#line 2860 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 11:
#line 421 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
          add_contextual_data_set_ignore_case(last_parser, (yyvsp[-1].num));
        }
#line 2868 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 12:
#line 427 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            add_contextual_data_set_selector_filter(last_parser, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
          }
#line 2877 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 13:
#line 432 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    {
            add_contextual_data_set_database_selector_template(last_parser, (yyvsp[0].cptr));
            free((yyvsp[0].cptr));
        }
#line 2886 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 16:
#line 700 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 1; }
#line 2892 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 17:
#line 701 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 0; }
#line 2898 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;

  case 18:
#line 702 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[0].num); }
#line 2904 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
    break;


#line 2908 "modules/add-contextual-data/add-contextual-data-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 1095 "modules/add-contextual-data/add-contextual-data-grammar.y" /* yacc.c:1906  */
