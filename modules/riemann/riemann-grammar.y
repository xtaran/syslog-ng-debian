...
riemann_type_option
        : KW_CACERT '(' string ')' { riemann_dd_set_tls_cacert(last_driver, $3); free($3); }
        | KW_CERT '(' string ')' { riemann_dd_set_tls_cert(last_driver, $3); free($3); }
        | KW_KEY '(' string ')' { riemann_dd_set_tls_key(last_driver, $3); free($3); }
        ;
