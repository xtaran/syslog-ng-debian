...
#line 70 "modules/diskq/diskq-grammar.c" /* yacc.c:316  */
...
#line 82 "modules/diskq/diskq-grammar.c" /* yacc.c:339  */
...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_ON_ERROR = 10511,
    KW_RETRIES = 10512,
    KW_DISK_BUFFER = 10514,
    KW_MEM_BUF_LENGTH = 10515,
    KW_DISK_BUF_SIZE = 10516,
    KW_RELIABLE = 10517,
    KW_MEM_BUF_SIZE = 10518,
    KW_QOUT_SIZE = 10519,
    KW_DIR = 10520
  };
#endif
...
#define KW_DISK_BUFFER 10514
#define KW_MEM_BUF_LENGTH 10515
#define KW_DISK_BUF_SIZE 10516
#define KW_RELIABLE 10517
#define KW_MEM_BUF_SIZE 10518
#define KW_QOUT_SIZE 10519
#define KW_DIR 10520
...
#line 443 "modules/diskq/diskq-grammar.c" /* yacc.c:358  */
/* Unqualified %code blocks.  */
#line 33 "modules/diskq/diskq-grammar.y" /* yacc.c:359  */
...
#line 66 "modules/diskq/diskq-grammar.y" /* yacc.c:359  */
...
#line 521 "modules/diskq/diskq-grammar.c" /* yacc.c:359  */
...
{
       0,   394,   394,   399,   398,   408,   409,   413,   414,   415,
     416,   417,   418,   679,   680,   684,   685,   686,   695,   702
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_REPLACE_PREFIX", "KW_ON_ERROR", "KW_RETRIES", "KW_DISK_BUFFER",
  "KW_MEM_BUF_LENGTH", "KW_DISK_BUF_SIZE", "KW_RELIABLE",
  "KW_MEM_BUF_SIZE", "KW_QOUT_SIZE", "KW_DIR", "'('", "')'", "'{'", "'}'",
  "';'", "':'", "$accept", "start", "dest_diskq", "$@1",
  "dest_diskq_options", "dest_diskq_option", "string", "yesno",
  "nonnegative_integer64", "nonnegative_integer", YY_NULLPTR
};
#endif
...
{
     -11,  -131,    15,  -139,  -139,  -139,  -136,  -138,  -135,  -134,
    -133,  -132,  -130,  -129,  -128,  -138,  -104,  -104,  -118,  -104,
    -104,  -122,  -139,  -139,  -139,  -139,  -127,  -126,  -139,  -139,
    -139,  -125,  -124,  -123,  -139,  -139,  -121,  -139,  -139,  -139,
    -139,  -139,  -139
};
...
static const yytype_uint8 yydefact[] =
{
       0,     0,     0,     3,     2,     1,     0,     6,     0,     0,
       0,     0,     0,     0,     0,     6,     0,     0,     0,     0,
       0,     0,     4,     5,    18,    19,     0,     0,    15,    16,
      17,     0,     0,     0,    13,    14,     0,     9,    10,     7,
       8,    11,    12
};
...
{
    -139,  -139,  -139,  -139,     9,  -139,  -139,  -139,    14,   -16
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     4,     6,    14,    15,    36,    31,    25,    26
};
...
{
      28,    29,    34,    32,    33,    35,     1,    30,     8,     9,
      10,    11,    12,    13,     3,     5,     7,    16,    17,    18,
      19,    24,    20,    21,    23,    22,    37,    38,    39,    40,
      41,    27,    42
};

static const yytype_uint8 yycheck[] =
{
     118,   119,   124,    19,    20,   127,    17,   125,   146,   147,
     148,   149,   150,   151,   145,     0,   152,   152,   152,   152,
     152,   125,   152,   152,    15,   153,   153,   153,   153,   153,
     153,    17,   153
};
...
{
       0,    17,   159,   145,   160,     0,   161,   152,   146,   147,
     148,   149,   150,   151,   162,   163,   152,   152,   152,   152,
     152,   152,   153,   162,   125,   166,   167,   166,   118,   119,
     125,   165,   167,   167,   124,   127,   164,   153,   153,   153,
     153,   153,   153
};
...
static const yytype_uint8 yyr1[] =
{
     ...
     163,   163,   163,   164,   164,   165,   165,   165,   166,   167
};
...
#line 309 "modules/diskq/diskq-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2515 "modules/diskq/diskq-grammar.c" /* yacc.c:1257  */
        break;

    case 127: /* LL_STRING  */
#line 309 "modules/diskq/diskq-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2521 "modules/diskq/diskq-grammar.c" /* yacc.c:1257  */
        break;

    case 129: /* LL_BLOCK  */
#line 309 "modules/diskq/diskq-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2527 "modules/diskq/diskq-grammar.c" /* yacc.c:1257  */
        break;

    case 164: /* string  */
#line 309 "modules/diskq/diskq-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2533 "modules/diskq/diskq-grammar.c" /* yacc.c:1257  */
        break;
...
#line 394 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2827 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 399 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    {
...
#line 2837 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
  ...
  case 4:
#line 404 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_check_plugin_settings(last_options); }
#line 2843 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 7:
#line 413 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_reliable_set(last_options, (yyvsp[-1].num)); }
#line 2849 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 8:
#line 414 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_mem_buf_size_set(last_options, (yyvsp[-1].num)); }
#line 2855 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 415 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_mem_buf_length_set(last_options, (yyvsp[-1].num)); }
#line 2861 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 10:
#line 416 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_disk_buf_size_set(last_options, (yyvsp[-1].num)); }
#line 2867 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 11:
#line 417 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_qout_size_set(last_options, (yyvsp[-1].num)); }
#line 2873 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 12:
#line 418 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { disk_queue_options_set_dir(last_options, (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2879 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 15:
#line 684 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 1; }
#line 2885 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 16:
#line 685 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 0; }
#line 2891 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 17:
#line 686 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[0].num); }
#line 2897 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 18:
#line 696 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    {
            CHECK_ERROR(((yyvsp[0].num) >= 0), (yylsp[0]), "It cannot be negative");
          }
#line 2905 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;

  case 19:
#line 703 "modules/diskq/diskq-grammar.y" /* yacc.c:1646  */
    {
            CHECK_ERROR(((yyvsp[0].num) <= G_MAXINT32), (yylsp[0]), "Must be smaller than 2^31");
          }
#line 2913 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
    break;


#line 2917 "modules/diskq/diskq-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 1079 "modules/diskq/diskq-grammar.y" /* yacc.c:1906  */
