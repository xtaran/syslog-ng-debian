...
xml_opt
        ...
        | KW_EXCLUDE_TAGS '(' string_list ')' { xml_parser_set_exclude_tags(last_parser, $3); g_list_free_full($3, free); }
        | KW_STRIP_WHITESPACES '(' yesno ')' { xml_parser_set_strip_whitespaces(last_parser, $3); }
        | parser_opt
        ;
