...
#line 429 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:358  */
...
#line 499 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:359  */
...
{
       0,   379,   379,   385,   384,   394,   395,   399,   400,   401,
     401,   405,   406,   407,   668,   669,   736,   747,   755,   759,
     913,   914,   920
};
#endif
...
{
       0,  -137,    11,  -134,  -138,  -138,  -138,   -81,  -133,  -132,
    -131,   -81,   -82,  -138,   -54,  -117,  -138,  -138,  -126,  -124,
    -121,  -138,   -54,  -138,  -138,  -120,   -54,  -119,  -117,   -36,
    -117,  -138,  -138,  -138,  -138,  -118,  -138,  -138,  -116,  -138,
    -115,  -138,  -138,  -138
};
...
{
       0,     0,     0,     0,     2,     1,     3,     9,     0,     0,
       0,     9,     0,     7,    13,     0,     4,     5,     0,     0,
       0,    10,    13,    14,    15,     0,    13,     0,     0,     0,
       0,    12,     8,    11,    19,     0,    18,    17,     0,    16,
       0,    20,    22,    21
};
...
{
    -138,  -138,  -138,  -138,     4,  -138,  -138,   -17,   -11,  -138,
    -138,  -138,  -138
};
...
{
      36,    22,     8,    18,    27,    31,     1,    23,     3,    33,
      24,     5,     6,    14,    15,    17,    16,    35,    37,    39,
      28,     9,    29,    19,    20,    30,     0,    32,    34,    41,
...
{
      36,    55,    83,    85,    15,    22,     6,   124,   145,    26,
     127,     0,   146,   146,   146,    11,   147,    28,    29,    30,
     146,   102,   146,   105,   106,   146,    -1,   147,   147,   147,
...
{
       0,     6,   153,   145,   154,     0,   146,   155,    83,   102,
     156,   157,   158,   163,   146,   146,   147,   156,    85,   105,
     106,   164,    55,   124,   127,   159,   160,   160,   146,   146,
     146,   159,   147,   159,   147,   160,    36,   160,   162,   160,
     161,   147,   147,   147
};
...
{
       0,   152,   153,   155,   154,   156,   156,   157,   157,   158,
     157,   159,   159,   159,   160,   160,   161,   162,   162,   163,
     164,   164,   164
};
...
#line 298 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2508 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1257  */
        break;

    case 127: /* LL_STRING  */
#line 298 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2514 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1257  */
        break;

    case 129: /* LL_BLOCK  */
#line 298 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2520 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1257  */
        break;

    case 160: /* string  */
#line 298 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2526 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1257  */
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 379 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2820 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 385 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    {
            last_parser = *instance = syslog_parser_new(configuration);
          }
#line 2828 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 4:
#line 389 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_parser; }
#line 2834 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 401 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    { last_msg_format_options = &((SyslogParser *) last_parser)->parse_options; }
#line 2840 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 11:
#line 405 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
...
#line 2846 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 12:
#line 406 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    { msg_format_options_process_flag(&((SyslogParser *) last_parser)->parse_options, "check-hostname");  }
#line 2852 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 16:
#line 737 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    {
...
#line 2864 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 17:
#line 748 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    {
...
#line 2876 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 18:
#line 755 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = LOG_SYSLOG; }
#line 2882 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 19:
#line 759 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    {
...
#line 2896 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 20:
#line 913 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    { last_msg_format_options->recv_time_zone = g_strdup((yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2902 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 21:
#line 915 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    {
...
#line 2912 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 22:
#line 921 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1646  */
    {
	    if (last_msg_format_options->default_pri == 0xFFFF)
	      last_msg_format_options->default_pri = LOG_NOTICE;
	    last_msg_format_options->default_pri = (last_msg_format_options->default_pri & 7) | (yyvsp[-1].num);
          }
#line 2922 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
    break;


#line 2926 "modules/syslogformat/syslog-parser-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 1068 "modules/syslogformat/syslog-parser-grammar.y" /* yacc.c:1906  */
