...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    KW_RETRIES = 10512,
    KW_KV_PARSER = 10514,
    KW_LINUX_AUDIT_PARSER = 10515,
    KW_PREFIX = 10516,
    KW_VALUE_SEPARATOR = 10517,
    KW_PAIR_SEPARATOR = 10518,
    KW_EXTRACT_STRAY_WORDS_INTO = 10519,
    KW_ALLOW_PAIR_SEPARATOR_OPTION = 10520
  };
#endif
/* Tokens.  */
...
#define KW_KV_PARSER 10514
#define KW_LINUX_AUDIT_PARSER 10515
#define KW_PREFIX 10516
#define KW_VALUE_SEPARATOR 10517
#define KW_PAIR_SEPARATOR 10518
#define KW_EXTRACT_STRAY_WORDS_INTO 10519
#define KW_ALLOW_PAIR_SEPARATOR_OPTION 10520
...
#line 441 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:358  */
...
#line 56 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:359  */
...
#line 514 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:359  */
...
{
       0,   385,   385,   391,   390,   397,   396,   405,   406,   410,
     411,   412,   419,   424,   429,   690,   691,   695,   696,   697,
     781
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_REPLACE_PREFIX", "KW_ON_ERROR", "KW_RETRIES", "KW_KV_PARSER",
  "KW_LINUX_AUDIT_PARSER", "KW_PREFIX", "KW_VALUE_SEPARATOR",
  "KW_PAIR_SEPARATOR", "KW_EXTRACT_STRAY_WORDS_INTO",
  "KW_ALLOW_PAIR_SEPARATOR_OPTION", "'('", "')'", "'{'", "'}'", "';'",
  "':'", "$accept", "start", "parser_expr_kv", "$@1", "$@2",
  "parser_kv_opts", "parser_kv_opt", "string", "yesno", "parser_opt", YY_NULLPTR
};
#endif
...
{
      -4,  -133,    15,  -136,  -135,  -137,  -137,  -137,  -137,  -102,
    -102,  -134,  -132,  -131,  -130,  -129,  -128,  -127,  -102,  -137,
    -126,  -113,  -113,  -113,  -113,  -113,  -115,  -137,  -137,  -137,
    -137,  -137,  -125,  -124,  -123,  -122,  -121,  -137,  -137,  -137,
    -120,  -137,  -137,  -137,  -137,  -137,  -137
};
...
{
    -137,  -137,  -137,  -137,  -137,    -9,  -137,   -17,  -137,  -137
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     2,     5,     9,    10,    17,    18,    32,    40,    19
};
...
{
      11,    20,     1,    37,    38,    33,    34,    35,    36,    28,
      39,    30,     3,     4,    31,     6,     7,     8,    21,     0,
      22,    23,    24,    25,    26,     0,    27,    29,    41,    42,
...
{
     102,    10,     6,   118,   119,    22,    23,    24,    25,    18,
     125,   124,   145,   146,   127,     0,   152,   152,   152,    -1,
...
{
       0,     6,   159,   145,   146,   160,     0,   152,   152,   161,
     162,   102,   147,   148,   149,   150,   151,   163,   164,   167,
     163,   152,   152,   152,   152,   152,   152,   153,   163,   153,
     124,   127,   165,   165,   165,   165,   165,   118,   119,   125,
     166,   153,   153,   153,   153,   153,   153
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,   158,   159,   161,   160,   162,   160,   163,   163,   164,
...
#line 299 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2513 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1257  */
        break;

    case 127: /* LL_STRING  */
#line 299 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2519 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1257  */
        break;

    case 129: /* LL_BLOCK  */
#line 299 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2525 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1257  */
        break;

    case 165: /* string  */
#line 299 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1257  */
      { free(((*yyvaluep).cptr)); }
#line 2531 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1257  */
        break;
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 385 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { YYACCEPT; }
#line 2825 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 3:
#line 391 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    {
	    last_parser = *instance = (LogParser *) kv_parser_new(configuration);
	  }
#line 2833 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 4:
#line 395 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_parser; }
#line 2839 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 5:
#line 397 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    {
	    last_parser = *instance = (LogParser *) linux_audit_parser_new(configuration);
	  }
#line 2847 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 6:
#line 401 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { (yyval.ptr) = last_parser; }
#line 2853 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 9:
#line 410 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { kv_parser_set_prefix(last_parser, (yyvsp[-1].cptr)); free((yyvsp[-1].cptr)); }
#line 2859 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 11:
#line 413 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    {
	    CHECK_ERROR((strlen((yyvsp[-1].cptr)) == 1), (yylsp[-1]), "kv-parser() only supports single-character values for value-separator()");
	    CHECK_ERROR((kv_parser_is_valid_separator_character((yyvsp[-1].cptr)[0])), (yylsp[-1]), "kv-parser() unsupported character for value-separator()");
            kv_parser_set_value_separator(last_parser, (yyvsp[-1].cptr)[0]);
            free((yyvsp[-1].cptr));
	  }
#line 2870 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 12:
#line 420 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    {
            kv_parser_set_pair_separator(last_parser, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
          }
#line 2879 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 13:
#line 425 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    {
            kv_parser_set_stray_words_value_name(last_parser, (yyvsp[-1].cptr));
            free((yyvsp[-1].cptr));
          }
#line 2888 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 17:
#line 695 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 1; }
#line 2894 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 18:
#line 696 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = 0; }
#line 2900 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 19:
#line 697 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    { (yyval.num) = (yyvsp[0].num); }
#line 2906 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;

  case 20:
#line 781 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1646  */
    {
...
#line 2920 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
    break;


#line 2924 "modules/kvformat/kv-parser-grammar.c" /* yacc.c:1646  */
      default: break;
    }
...
#line 1090 "modules/kvformat/kv-parser-grammar.y" /* yacc.c:1906  */
