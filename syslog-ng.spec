...
[ -d "${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.7.3" ] || ./install-sh -d "${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.7.3"
./install-sh -o root -g root -m 0644 NEWS \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.7.3/NEWS
./install-sh -o root -g root -m 0644 AUTHORS \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.7.3/AUTHORS
./install-sh -o root -g root -m 0644 COPYING \
  ${RPM_BUILD_ROOT}/%{_prefix}/share/doc/syslog-ng-3.7.3/COPYING
...
%{prefix}/bin/loggen
%{_mandir}/*
%docdir %{_prefix}/share/doc/syslog-ng-3.7.3
%{_prefix}/share/doc/syslog-ng-3.7.3/*
...
%changelog
* Mon Sep 14 2009 Balazs Scheidler <bazsi@balabit.com> 3.7.3-1
- Removed some more Premium Edition related cruft.
* Wed Sep 02 2009 Balazs Scheidler <bazsi@balabit.com> 3.7.3-1
- Removed the references to the documentation and libzlicense-devel
* Wed Apr 04 2007 Tamas Pal <folti@balabit.com> 3.7.3-1
